...
namespace WindowsFormsApp1
{
    public partial class buy3 : Form
    {
        ...
        public static buy3 buy;
        public static buy3 buy21
        {
            get
            {
                if (buy == null)
        ...
        private void buy3_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            textBox3.Text = salesr3.selectedrow.Cells[1].Value.ToString();
            textBox1.Text = salesr3.selectedrow.Cells[2].Value.ToString();
            textBox5.Text = salesr3.selectedrow.Cells[3].Value.ToString();
        }
