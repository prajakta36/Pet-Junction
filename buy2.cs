...
namespace WindowsFormsApp1
{
    public partial class buy2 : Form
    {
        ...
        SqlCommand cmd;
            ...
            public static buy2 buy;
            public static buy2 buy21
            {
                get
                {
                    if (buy == null)
        ...
        private void buy2_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            textBox3.Text = salesr2.selectedrow.Cells[1].Value.ToString();
            textBox1.Text = salesr2.selectedrow.Cells[2].Value.ToString();
            textBox5.Text = salesr2.selectedrow.Cells[3].Value.ToString();  
        }
